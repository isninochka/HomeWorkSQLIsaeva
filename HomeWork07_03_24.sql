...
db.products.updateMany({$or:[{_id:1},{_id:4}]},{$push:{country:"Испания"}})

/*6.Товарам с id 1 и 3 добавить в качестве поставщиков Америку и Бразилию*/
db.products.updateMany({$or:[{_id:1},{_id:3}]},{$push:{country:{$each:["Америка","Бразилия"]}}})
...
db.products.updateOne({$or:[{_id:1},{_id:3},{_id:6}]},{$pull:{country:"Италия"}})
